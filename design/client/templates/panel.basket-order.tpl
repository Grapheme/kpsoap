...
{/if}
    ...
    <div class="CostOfDelivery" {if $page.panels_data.basket.price >= 2500}style="disaplay:none;"{/if}>
		<div class="clear"><!-- --></div>
		...
		<div class="clear"><!-- --></div>
		<div class="result">Итого: <span class="price-with-cost-delivery">{$page.panels_data.basket.price + 300}</span></div>
	</div>
