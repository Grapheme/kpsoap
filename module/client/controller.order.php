...
<p>Отправка готовой продукции происходит в течение недели. Мы передаем все заказы один раз в неделю в отделение «Почты России» и получаем треккинг по каждой посылке. На следующий день после отправки мы присылаем вам трек номер посылки для того чтобы вы могли отследить ее на сайте почты.</p>
<p>По вопросам вашего заказа можно связаться с нами по телефону 8 (938) 456 14 64</p>
