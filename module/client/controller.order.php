				...
				for ($i=0; $i<$produce->num_rows; $i++) {
					...
					$order_list .= "
							<tr>
								...
								<!--<img src=\"http://{$_SERVER['SERVER_NAME']}/img-dbimage/catalog/{$produce->cell[$i]['group']}/".preg_replace('#\.([a-z]{3}$)#i','-$1',$produce->cell[$i]['photo'])."-100c100-85.jpg\" title=\"{$produce->cell[$i]['title']}\" /></td>-->
...
<p>Наша частная мыловарня расположена в поселке «Медовеевка» Краснополянского района, поэтому мы пришлем Вам заказ по почте. Стоимость доставки одной посылки – 300 руб, в случае осуществления заказа на сумму свыше 2 500 руб – бесплатно!</p>
<p>Отправка готовой продукции происходит один раз в неделю по пятницам. В этот день мы передаем все заказы за неделю в отделение «Почты России» и получаем треккинг по каждой посылке. Для оперативного получения вашего заказа, желательно все электронные оплаты произвести до пятницы.</p>
<p>Пожалуйста, ожидайте трек-номер вашей посылки в будущий понедельник.</p>
<p>По вопросам вашего заказа можно связаться с вашим персональным менеджером Семиной Александрой по телефону 8 (938) 456 14 64</p>
